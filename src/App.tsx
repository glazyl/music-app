...
export default function App() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // Ensure we use popup as requested, but handle potential blockers
                ...
                {welcomeAuthMode === 'options' ? (
                  ...
                  >
                    ...
                    <button 
                      ...
                      className="w-full flex items-center justify-center gap-4 bg-white text-black py-5 rounded-2xl font-black text-sm uppercase tracking-[0.2em] active:scale-[0.98] transition-transform shadow-xl disabled:opacity-50"
                    >
                      {isAuthProcessing && welcomeAuthMode === 'options' ? (
                    ...
                    <button 
                      ...
                      disabled={isAuthProcessing}
                      className="w-full flex items-center justify-center gap-4 bg-white/5 border border-white/10 text-white py-5 rounded-2xl font-black text-sm uppercase tracking-[0.2em] active:scale-[0.98] transition-transform shadow-xl disabled:opacity-50"
                    >
                      Create Account
                    </button>
                    ...
                    <button 
                      ...
                      disabled={isAuthProcessing}
                      className="text-[10px] font-black uppercase text-neon-green/60 tracking-[0.2em] py-2 disabled:opacity-50"
                    >
